#include "Constants/LightingConstantsBuffer.h"
...
float4 main(PixelShaderInput input) : SV_TARGET
{
	...
	//return float4(texturesColor.xyz,1.0f);
	...
	float3 viewDir = normalize(eyePos.xyz - input.worldPos); // Vector from surface point to camera
