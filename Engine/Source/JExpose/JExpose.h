...
#define JCLASS(CLASS) static std::vector<std::pair<std::string,bool>> Get##CLASS##RequiredAttributes()\
{\
	return std::vector<std::pair<std::string,bool>>({
#define JEXPOSE(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JEXPOSE_TRANSFORM(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JEXPOSE_ENUM(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JEXPOSE_VECTOR(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JEXPOSE_VECTOR_TRANSFORM(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JEXPOSE_SET(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JEXPOSE_MAP_TRANSFORM(KEYTYPE,VALUETYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) std::make_pair(#ATT,REQUIREDTOCREATE),
#define JTRACKUUID(CLASS,NAME,LIMIT)
