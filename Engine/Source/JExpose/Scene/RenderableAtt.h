JCLASS(Renderable)
JEXPOSE(std::string, uuid, "846455$UUID", jedv_t_hidden, 0, false)
JEXPOSE(std::string, name, "846455$NAME", jedv_t_string, 0, true)
...
JEXPOSE(bool, animationLoop, false, jedv_t_hidden, 1, false)
