...
void CreateSystemTemplates() {
	...
	//CreateShader("ShadowMapAlpha", R"( { "systemCreated" : true })"_json);
	//CreateShader("ShadowMapAlphaSkinning", R"( { "systemCreated" : true })"_json);
	...
	CreateMaterial("Teapot", R"({ "shader":"Teapot", "systemCreated":true, "samplers":[{ "Filter":"MAG_MIP_LINEAR", "AddressU":"ADDRESS_MODE_BORDER", "AddressV":"ADDRESS_MODE_BORDER", "AddressW":"ADDRESS_MODE_BORDER", "MipLODBias":0, "MaxAnisotropy":0, "ComparisonFunc":"NEVER", "BorderColor":"OPAQUE_WHITE", "MinLOD":0.0, "MaxLOD":3.4028234663852886e+38, "ShaderRegister":0, "RegisterSpace":0, "ShaderVisibility":"PIXEL" }] })"_json);
	CreateMaterial("Floor", R"({ "shader":"Floor", "systemCreated":true, "samplers":[{ "Filter":"MAG_MIP_LINEAR", "AddressU":"ADDRESS_MODE_BORDER", "AddressV":"ADDRESS_MODE_BORDER", "AddressW":"ADDRESS_MODE_BORDER", "MipLODBias":0, "MaxAnisotropy":0, "ComparisonFunc":"NEVER", "BorderColor":"OPAQUE_WHITE", "MinLOD":0.0, "MaxLOD":3.4028234663852886e+38, "ShaderRegister":0, "RegisterSpace":0, "ShaderVisibility":"PIXEL" }] })"_json);
	CreateMaterial("ShadowMap", R"({ "shader":"ShadowMap", "systemCreated":true, "samplers":[{ "Filter":"MAG_MIP_LINEAR", "AddressU":"ADDRESS_MODE_BORDER", "AddressV":"ADDRESS_MODE_BORDER", "AddressW":"ADDRESS_MODE_BORDER", "MipLODBias":0, "MaxAnisotropy":0, "ComparisonFunc":"NEVER", "BorderColor":"OPAQUE_WHITE", "MinLOD":0.0, "MaxLOD":3.4028234663852886e+38, "ShaderRegister":0, "RegisterSpace":0, "ShaderVisibility":"PIXEL" }] })"_json);
	//CreateMaterial("ShadowMapAlpha", R"({ "shader":"ShadowMapAlpha", "systemCreated":true, "samplers":[{ "Filter":"MAG_MIP_LINEAR", "AddressU":"ADDRESS_MODE_BORDER", "AddressV":"ADDRESS_MODE_BORDER", "AddressW":"ADDRESS_MODE_BORDER", "MipLODBias":0, "MaxAnisotropy":0, "ComparisonFunc":"NEVER", "BorderColor":"OPAQUE_WHITE", "MinLOD":0.0, "MaxLOD":3.4028234663852886e+38, "ShaderRegister":0, "RegisterSpace":0, "ShaderVisibility":"PIXEL" }] })"_json);
	//CreateMaterial("ShadowMapAlphaSkinning", R"({ "shader":"ShadowMapAlphaSkinning", "systemCreated":true, "samplers":[{ "Filter":"MAG_MIP_LINEAR", "AddressU":"ADDRESS_MODE_BORDER", "AddressV":"ADDRESS_MODE_BORDER", "AddressW":"ADDRESS_MODE_BORDER", "MipLODBias":0, "MaxAnisotropy":0, "ComparisonFunc":"NEVER", "BorderColor":"OPAQUE_WHITE", "MinLOD":0.0, "MaxLOD":3.4028234663852886e+38, "ShaderRegister":0, "RegisterSpace":0, "ShaderVisibility":"PIXEL" }] })"_json);
