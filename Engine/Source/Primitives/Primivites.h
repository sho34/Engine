...
namespace Primitives {
	...
	template<typename T>
	void LoadPrimitiveIntoMesh(const std::unique_ptr<MeshInstance>& mesh, void* params) {
...
static const std::map<std::string, std::function<void(const std::unique_ptr<Templates::MeshInstance>&, void* params)>> LoadPrimitiveIntoMeshFunctions =
{
