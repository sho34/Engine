...
struct KeyboardButton {
  ...
  void Initialize(ComPtr<ID2D1DeviceContext5> d2d1DeviceContext, ComPtr<IDWriteFactory> dWriteFactory, std::wstring label, D2D1::ColorF labelColor, FLOAT fontSize=32.0f);
  void Destroy();
