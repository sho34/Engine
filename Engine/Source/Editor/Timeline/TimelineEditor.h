...
struct TimelineEditor
{
	...
	void DrawTimeline(Sequence& sequence, ImVec2 timelinePos, ImVec2 timelineSize, bool canInteract, std::function<void(TransformationKeyFrame*)> setTransformationKeyFrame);
	...
	void Draw(Sequence& sequence, ImVec2 pos, ImVec2 size, std::function<void(TransformationKeyFrame*)> setTransformationKeyFrame);
	...
	void AddSoundFXElementToChannel(Sequence& sequence, int channelId, SequenceChanelElementSoundFX* elem);
