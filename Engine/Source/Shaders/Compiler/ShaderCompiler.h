...
namespace ShaderCompiler {
	...
	inline static std::map<ShaderType, std::wstring> shaderEntryPoint =
	{
	...
	inline static std::map<ShaderType, std::wstring> shaderTarget =
	{
	...
	inline static std::map<ShaderType, std::wstring> shaderDefine =
	{
